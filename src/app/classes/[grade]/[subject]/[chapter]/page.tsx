...
export default function DynamicChapterPage() {
    ...
    useEffect(() => {
        const fetchChapterData = async () => {
            try {
                ...
                if (mcqsData.success) {
                    // Transform database fields if necessary (mapping from database snakes to frontend camels if needed)
                    // Our API already returns what we need generally, but we ensure id mapping
    ...
    const basePath = `/classes/${grade}/${subjectSlug}`;
