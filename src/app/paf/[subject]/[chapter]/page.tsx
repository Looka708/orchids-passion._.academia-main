...
export default function GenericDynamicChapterPage() {
    const params = useParams();
    const pathname = usePathname();
    const subjectSlug = params.subject as string;
    const chapterSlug = params.chapter as string;

    // Determine course type (afns, paf, mcj, mcm)
    ...
    const basePath = `/${courseType}/${subjectSlug}`;

    return (
        <TestPageClient
            grade={courseType.toUpperCase()}
